...
* <font color = "darkorchid4"> There does not appear to be a significant difference in the occurances within three sections (danger, neutral, safety) between the two species.</font>
    + not sure if this was the correct way to calculate, since the occurances are not independent -if you are in the neutral, you had to pass through the safety section to get there. 
